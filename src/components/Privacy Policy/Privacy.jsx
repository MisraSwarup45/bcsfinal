...
function Privacy() {
    ...
    <header className="Header">
        ...
        <div className="Name--content">
            We respect the privacy of website visitors and are aware that when you choose to provide us personal information, you are placing your faith in us to handle it responsibly.
        </div>
        <div className="Text">
            The website(s) and mobile applications (collectively, the "Sites") provided by BigDigitalMedia and/or other BCS group companies are covered by this privacy policy ("BCS," "we," or "us"). Under the terms of this Policy, BCS is the data controller of the personal data you disclose with BCS.
<br /><br />
In addition to www.BCS.com, any websites and mobile apps made and maintained by BCS are included in the Sites.
<br /><br />
BCS is very concerned about user privacy since they recognize how important it is to you. In accordance with our Privacy Policy, we are committed to safeguarding your personal data, which includes any information you provide to us that may be used to identify you.
<br /><br />
In its sole discretion, BCS has the right to periodically modify this privacy statement. As a result, we urge you to review the most recent version of the privacy policy each time you visit one of our sites.
<br /><br />
Along the way, the Policy defines a few terms. Simply click on the bolded phrase to discover its definition, or refer to the definitions at the bottom of this Policy.
        </div>
