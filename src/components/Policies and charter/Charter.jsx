    ...
    <header className="Header">
      ...
      <div className="Text space">
        <Collapsible className="Dropdown" trigger={<div className='label'>
          <div>Information we collect & how we use it</div>
        ...
        <Collapsible className="Dropdown" trigger={<div className='label'>
          <div>Use of cookies on this site</div>
          <div><img className='arrow' src={dropdown}></img></div>
        </div> }>
          <p className="Dropdown--content">
        ...
        <Collapsible className="Dropdown" trigger={<div className='label'>
          <div>Who we share your personal data with</div>
          <div><img className='arrow' src={dropdown}></img></div>
        </div>}>
          <p className="Dropdown--content">
        ...
        <Collapsible className="Dropdown" trigger={<div className='label'>
          <div>Security of you personal data</div>
          <div><img className='arrow' src={dropdown}></img></div>
        </div>}>
          <p className="Dropdown--content">
